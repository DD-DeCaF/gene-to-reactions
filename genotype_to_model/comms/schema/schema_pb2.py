...
_JSONSCHEMA_MESSAGEENTRY = _descriptor.Descriptor(
  name='MessageEntry',
  full_name='v.JSONSchema.MessageEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='v.JSONSchema.MessageEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='v.JSONSchema.MessageEntry.value', index=1,
...
_JSONSCHEMA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='v.JSONSchema.message', index=13,
  ...
  nested_types=[_JSONSCHEMA_MESSAGEENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_JSONSCHEMA_MESSAGEENTRY.fields_by_name['value'].message_type = _JSONSCHEMA
_JSONSCHEMA_MESSAGEENTRY.containing_type = _JSONSCHEMA
...
_JSONSCHEMA.fields_by_name['message'].message_type = _JSONSCHEMA_MESSAGEENTRY
...
JSONSchema = _reflection.GeneratedProtocolMessageType('JSONSchema', (_message.Message,), dict(
  ...
  MessageEntry = _reflection.GeneratedProtocolMessageType('MessageEntry', (_message.Message,), dict(
    DESCRIPTOR = _JSONSCHEMA_MESSAGEENTRY,
    __module__ = 'schema.schema_pb2'
    # @@protoc_insertion_point(class_scope:v.JSONSchema.MessageEntry)
    ))
  ,
...
_sym_db.RegisterMessage(JSONSchema.MessageEntry)
...
_JSONSCHEMA_MESSAGEENTRY.has_options = True
_JSONSCHEMA_MESSAGEENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
import grpc
